...
* `Documentation <http://netrino-ui.readthedocs.io>`__.
...
Netrino ui infrastructure and code is hosted on `GitHub <https://github.com/TachyonProject/netrino_ui>`_.
...
.. code:: bash
    ...
    $ git clone https://github.com/TachyonProject/netrino_ui.git
...
You can manually test changes to the netrino_ui by switching to the
