...
setup_dict = dict(
    ...
    entry_points={
        # 'console_scripts': [
        #     'tachyonic_netrino_ui_cli = tachyonic_netrino_ui.main:entry_point'
        # ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'tachyonic_netrino_ui_gui = tachyonic_netrino_ui.gui:entry_point'
        # ]
    }
)
